...
<head>
	...
	-->
		...
		<link rel="stylesheet" href="/coursecss/index.css">
</head>
<body>
			...
			<div class="layui-header header header-demo" style="height: 80px;">
				<div class="layui-main"  style="text-align: right;">
					...
					<ul class="layui-nav daohang" style="height: 80px;">
						<li class="layui-nav-item " style="height:80px;line-height:80px;position: absolute;bottom: 0px;right: 215px;">
							<a href="/course/teacher/homework.jsp">任务</a>
						</li>					
						<li class="layui-nav-item " style="height:80px;line-height:80px;position: absolute;bottom: 0px;right: 165px;">
							<a href="/course/teacher/named.jsp">点名</a>
						</li>
