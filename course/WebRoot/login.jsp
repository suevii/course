				...
				<div id="large-header" class="large-header">
					...
					<div class="signpos">
						<div class="col-sm-offset-3 col-md-offset-3 col-sm-6 col-md-6">
							...
							<s:form role="form" class="form-horizontal" action="login"
								method="post">
										...
										<div class="form-group">
											...
											<div>
												<div class="iradio checked">
													<input type="radio" name="character" value="student"
														title="学生" checked><label>学生</label>
												</div>
												<div class="iradio">
													<input type="radio" name="character" value="teacher"
														title="教师"><label>教师</label>
												</div>
											</div>
										</div>
										<div class="form-group">
											<button class="btn btn-block btn-success pull-right"
